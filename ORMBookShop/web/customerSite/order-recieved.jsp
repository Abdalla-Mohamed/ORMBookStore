...
<html>
    ...
    <body>
      ...
      Click here to print a copy of your order confirmation.</p>
                              <a href="/ORMBookShop/customerSite/grid-view.jsp" class="more-btn ">Continue Shopping</a>
                          </figure>
                              <figure class="left-sec">
                              <div class="r-title-bar">
                                      <strong class="green-t">My Profile</strong>
                              </div>
                            

                              <a href="/ORMBookShop/customerSite/profile.jsp" class="grey-btn">check your Profile</a>
                          </figure>
                      </section>
