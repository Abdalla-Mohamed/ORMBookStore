...
<!--            <li class="menu-list"><a href="#"><i class="lnr lnr-book"></i>  <span>Pages</span></a> 
            ...
            <li class="menu-list"><a href="sign-in.jsp"><i class="fa fa-sign-in"></i>  <span>Login</span></a> 
            <li class="menu-list"><a href="sign-up.jsp"><i class="fa fa-book"></i>  <span>Books</span></a> 
            <li class="menu-list"><a href="authers.jsp"><i class="fa fa-user"></i>  <span>Authors</span></a> 
            <li class="menu-list"><a href="chargeCard.jsp"><i class="fa fa-money"></i>  <span>Charge</span></a></li>
        </ul>
        <!--sidebar nav end-->
    </div>
</div>
